...
class _ChangeGradeClassState extends State<ChangeGradeClass> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle _textStyle = _themeData.textTheme.bodyMedium!
        .copyWith(fontSize: 24, color: Colors.grey);
    TextStyle _selectedTextStyle = _themeData.textTheme.headlineSmall!
        .copyWith(fontSize: 24, color: _themeData.textTheme.bodyLarge?.color);
    return AlertDialog(
      title: Text("학년/반 변경"),
